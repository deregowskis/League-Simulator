...
public class Tournament {
    ...
    void table() {
        ...
        System.out.println();
        System.out.format("%3s %19s %3s %3s %3s %3s %4s %4s %5s %5s","POS","TEAM","GP","W","D","L","GF","GA","GD","Pts");
        for(int i = 0;i<4;i++){
        ...
        //frame.tableLabels.get(0).setText(String.format("%3s %19s %3s %3s %3s %3s %4s %4s %5s %5s","POS","TEAM","GP","W","D","L","GF","GA","GD","Pts"));
        System.out.println();
        /*for (int i = 0; i < 4; i++) {
            System.out.format("%1s %20s %1s %1s %1s %1s %1s %1s %1s %1s %1s %2s %1s %2s %1s" +
                            " %3s %1s %2s",i + 1+ ".",table.get(i).name, " "
                    ,table.get(i).matches," ",table.get(i).wins,
                    " ",table.get(i).draws," ",table.get(i).loses," ",table.get(i).goalsfor," ",
                    table.get(i).goalsagainst," " ,(table.get(i).goalsfor - table.get(i).goalsagainst)," ",table.get(i).points);
            frame.tableLabels.get(i+1).setText(String.format("%1s %20s %1s %1s %1s %1s %1s %1s %1s %1s %1s %2s %1s %2s %1s" +
                            " %3s %1s %2s",i + 1+ ".",table.get(i).name, " "
                    ,table.get(i).matches," ",table.get(i).wins,
                    " ",table.get(i).draws," ",table.get(i).loses," ",table.get(i).goalsfor," ",
                    table.get(i).goalsagainst," " ,(table.get(i).goalsfor - table.get(i).goalsagainst)," ",table.get(i).points));
    ...
    void topGoalscorers() {
        ...
        System.out.println();
        System.out.format("%40s", "TOP GOALSCORERS");
        frame.classificationstat.get(0).setText(String.format("%40s", "TOP GOALSCORERS"));
        System.out.println();
        System.out.println("POS.|          PLAYER          |        CLUB         |  GOALS");
        ...
        for (int i = 0; i < Math.min(goalscorers.size(),10); i++) {
            if(goalscorers.get(i).goals==counter){
                System.out.format("%10s %1s %22s %1s %17s %1s %2s", "=", "|  ", goalscorers.get(i).name +" "
                ...
                System.out.format("%10s %1s %22s %1s %17s %1s %2s", i+1, "|  ", goalscorers.get(i).name + " "
                                + goalscorers.get(i).surname, "|  ", goalscorers.get(i).club, "|  ",
                        goalscorers.get(i).goals);
    ...
    void topAssistants() {
        ...
        System.out.println();
        System.out.format("%40s", "TOP ASSISTANTS");
        frame.classificationstat.get(0).setText(String.format("%40s", "TOP ASSISTANTS"));
        System.out.println();
        System.out.println("POS.|          PLAYER          |         CLUB        |  ASSISTS");
        ...
        for (int i = 0; i < Math.min(assistants.size(),10); i++) {
            if(assistants.get(i).assists==counter){
                System.out.format("%3s %1s %22s %1s %17s %1s %2s", "=", "|  ", assistants.get(i).name +" "
                ...
                System.out.format("%3s %1s %22s %1s %17s %1s %2s", i+1, "|  ", assistants.get(i).name + " "
                                + assistants.get(i).surname, "|  ", assistants.get(i).club, "|  ",
                        assistants.get(i).assists);
    ...
    void topCanadians() {
        ...
        System.out.format("%40s", "CANADIAN CLASSIFICATION");
        System.out.println();
        System.out.println("POS.|          PLAYER          |         CLUB        |  SCORE (G+A)");
        ...
        for (int i = 0; i < Math.min(10,canadians.size()); i++) {
            if(canadians.get(i).canadians==counter){
                System.out.format("%3s %1s %22s %1s %17s %1s %2s", "=", "|  ", canadians.get(i).name +" "
                ...
                System.out.format("%3s %1s %22s %1s %17s %1s %2s", i+1, "|  ", canadians.get(i).name + " "
                                + canadians.get(i).surname, "|  ", canadians.get(i).club, "|  ",
                        canadians.get(i).canadians + " (" + canadians.get(i).goals + "+" + canadians.get(i).assists + ")");
    ...
    void topYellows() {
        ...
        System.out.println();
        System.out.format("%40s", "THE MOST YELLOW CARDS");
        ...
        System.out.println("POS.|          PLAYER          |         CLUB        |  YELLOWS");
        System.out.println("--------------------------------------------------------------------");
        frame.classificationstat.get(2).setText(("--------------------------------------------------------------------"));
        int counter = 0;
        for (int i = 0; i < Math.min(yellows.size(),10); i++) {
            if(yellows.get(i).yellows==counter){
                ...
                System.out.format("%3s %1s %22s %1s %17s %1s %2s", "=", "|  ", yellows.get(i).name +" "
                                + yellows.get(i).surname, "|  ", yellows.get(i).club, "|  ",
                        yellows.get(i).yellows);
                System.out.println();
            }else {
                frame.classificationstat.get(i+3).setText(String.format("%3s %1s %22s %1s %17s %1s %2s", i+1, "|  ", yellows.get(i).name + " "
                                + yellows.get(i).surname, "|  ", yellows.get(i).club, "|  ",
                        yellows.get(i).yellows));
                System.out.format("%3s %1s %22s %1s %17s %1s %2s", i+1, "|  ", yellows.get(i).name + " "
                                + yellows.get(i).surname, "|  ", yellows.get(i).club, "|  ",
                        yellows.get(i).yellows);
                System.out.println();
            }
    ...
    void topReds() {
        ...
        System.out.println();
        System.out.format("%40s", "THE MOST RED CARDS");
        frame.classificationstat.get(0).setText(String.format("%40s", "THE MOST RED CARDS"));
        System.out.println();
        System.out.println("POS.|          PLAYER          |         CLUB        |  REDS");
    ...
    void topFouls() {
        ...
        System.out.println();
        System.out.format("%40s", "THE MOST FOULING PLAYERS");
        frame.classificationstat.get(0).setText(String.format("%40s", "THE MOST FOULING PLAYERS"));
        System.out.println();
        System.out.println("POS.|          PLAYER          |         CLUB        |  FOULS (Y+R)");
    ...
    void topFouled() {
        ...
        System.out.println();
        System.out.format("%40s", "THE MOST FREQUENT FOULED PLAYERS");
        frame.classificationstat.get(0).setText(String.format("%40s", "THE MOST FREQUENT FOULED PLAYERS"));
        System.out.println();
        System.out.println("POS.|          PLAYER          |         CLUB        |  FOULED");
        ...
        for (int i = 0; i < Math.min(10,fouled.size()); i++) {
            if(fouled.get(i).fouled==counter){
                System.out.format("%3s %1s %22s %1s %17s %1s %2s", "=", "|  ", fouled.get(i).name +" "
                ...
                System.out.format("%3s %1s %22s %1s %17s %1s %2s", i+1, "|  ", fouled.get(i).name + " "
                                + fouled.get(i).surname, "|  ", fouled.get(i).club, "|  ",
                        fouled.get(i).fouled);
    ...
    void topShoots() {
        ...
        System.out.println();
        System.out.format("%40s", "THE MOST FREQUENT SHOOTING PLAYERS");
        frame.classificationstat.get(0).setText(String.format("%40s", "THE MOST FREQUENT SHOOTING PLAYERS"));
        System.out.println();
        System.out.println("POS.|          PLAYER          |         CLUB        |  SHOOTS (OT+G)");
        ...
        for (int i = 0; i < Math.min(10,shoots.size()); i++) {
            if(shoots.get(i).shoots==counter){
                System.out.format("%3s %1s %22s %1s %17s %1s %2s", "=", "|  ", shoots.get(i).name +" "
                ...
                System.out.format("%3s %1s %22s %1s %17s %1s %2s", i+1, "|  ", shoots.get(i).name + " "
                                + shoots.get(i).surname, "|  ", shoots.get(i).club, "|  ",
                        shoots.get(i).shoots + " (" + shoots.get(i).shootsonTarget + "+" + shoots.get(i).goals + ")");
                System.out.println();
